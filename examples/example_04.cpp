...
//==============================================================================
        ...
        vertex_shader->load_from_file("resources/shaders/texture_array/texture_array_v.spv");

        // create the fragment shader from a pre compiled SPIR-V file
        vka::shader* fragment_shader = C.new_shader_module("fs");
        fragment_shader->load_from_file("resources/shaders/texture_array/texture_array_f.spv");
